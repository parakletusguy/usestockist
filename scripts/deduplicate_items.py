...
def fast_deduplicate():
    ...
    DEFAULT_DEPTS = {
        ...
        'meat pie': ['Retail', 'Kitchen (Nox)'],
        'small chops': ['Retail', 'Kitchen (Nox)'],
        'parfait': ['Retail', 'Nox'],
        'serviette white': ['Retail', 'Bar', 'Kitchen (Nox)'],
        'straw': ['Retail', 'Bar'],
        'bbq sauce': ['Kitchen (Nox)', 'Retail'],
        'ketchup': ['Kitchen (Nox)', 'Retail'],
        'foil': ['Kitchen (Nox)', 'Retail'],
        'paper plate': ['Kitchen (Nox)', 'Retail'],
        'salt': ['Retail', 'Kitchen (Nox)'],
        'sugar': ['Retail', 'Kitchen (Nox)'],
        'vegetable oil': ['Retail', 'Kitchen (Nox)'],
    }
