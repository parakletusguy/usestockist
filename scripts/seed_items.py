...
ITEMS_CATALOG: List[Dict[str, Any]] = [
    ...
    {'name': 'Cube Water', 'category': 'Beverages', 'unit': 'bottle', 'departments': ['Cube'], 'cost': 0},
    {'name': 'Cube Soda Drink', 'category': 'Beverages', 'unit': 'can', 'departments': ['Cube'], 'cost': 0},
    {'name': 'POS Roll', 'category': 'Supplies', 'unit': 'roll', 'departments': ['Retail', 'Cube', 'Bar'], 'cost': 0},
    {'name': 'Film Mix', 'category': 'Supplies', 'unit': 'pack', 'departments': ['Retail'], 'cost': 0},
    {'name': 'Large Popcorn', 'category': 'Food', 'unit': 'pack', 'departments': ['Retail'], 'cost': 5500},
    {'name': 'Medium Popcorn', 'category': 'Food', 'unit': 'pack', 'departments': ['Retail'], 'cost': 4500},
    {'name': 'Regular Popcorn', 'category': 'Food', 'unit': 'pack', 'departments': ['Retail'], 'cost': 4000},
    {'name': 'Thermal Roll', 'category': 'Supplies', 'unit': 'roll', 'departments': ['Retail'], 'cost': 0},

    # 2. Drinks (Traditional)
    {'name': 'Soda Drinks', 'category': 'Beverages', 'unit': 'can', 'departments': ['Retail', 'Bar'], 'cost': 1200},
    ...
    {'name': 'Ketchup', 'category': 'Food', 'unit': 'bottle', 'departments': ['Kitchen (Nox)', 'Retail'], 'cost': 0},
    ...
    {'name': 'Mayonnaise', 'category': 'Food', 'unit': 'bottle', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Meat Pie', 'category': 'Food', 'unit': 'pcs', 'departments': ['Retail', 'Kitchen (Nox)'], 'cost': 1500},
    {'name': 'Doughnut', 'category': 'Food', 'unit': 'pcs', 'departments': ['Retail', 'Kitchen (Nox)'], 'cost': 0},
    {'name': 'Burger', 'category': 'Food', 'unit': 'pcs', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Parfait', 'category': 'Food', 'unit': 'pcs', 'departments': ['Retail', 'Nox'], 'cost': 4000},
    {'name': 'Curry', 'category': 'Food', 'unit': 'pack', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Pepper', 'category': 'Food', 'unit': 'pack', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Shawarma Bread', 'category': 'Food', 'unit': 'pack', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Portioned Chicken', 'category': 'Food', 'unit': 'kg', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Hotdog Sausages', 'category': 'Food', 'unit': 'pcs', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Condensed Milk', 'category': 'Food', 'unit': 'can', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Sliced Cake', 'category': 'Food', 'unit': 'pcs', 'departments': ['Retail', 'Kitchen (Nox)'], 'cost': 0},
    {'name': 'Small Chops', 'category': 'Food', 'unit': 'pack', 'departments': ['Retail', 'Kitchen (Nox)'], 'cost': 4000},
    ...
    {'name': 'Hotdog Bread Bun', 'category': 'Food', 'unit': 'pcs', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    {'name': 'Corn Dog', 'category': 'Food', 'unit': 'pcs', 'departments': ['Kitchen (Nox)'], 'cost': 0},
    ...
    {'name': 'Salt', 'category': 'Food', 'unit': 'pack', 'departments': ['Retail', 'Kitchen (Nox)'], 'cost': 0},
    {'name': 'Sugar', 'category': 'Food', 'unit': 'pack', 'departments': ['Retail', 'Kitchen (Nox)'], 'cost': 0},
    {'name': 'Vegetable Oil', 'category': 'Food', 'unit': 'ltr', 'departments': ['Retail', 'Kitchen (Nox)'], 'cost': 0},

    # 5. Consumables
    {'name': 'Foil', 'category': 'Supplies', 'unit': 'roll', 'departments': ['Kitchen (Nox)', 'Retail'], 'cost': 0},
    {'name': 'Paper Plate', 'category': 'Supplies', 'unit': 'pack', 'departments': ['Kitchen (Nox)', 'Retail'], 'cost': 0},
    {'name': 'Rubber Band', 'category': 'Supplies', 'unit': 'pack', 'departments': ['Retail'], 'cost': 0},
    {'name': 'Serviette White', 'category': 'Supplies', 'unit': 'pack', 'departments': ['Retail', 'Bar', 'Kitchen (Nox)'], 'cost': 0},
    ...
    {'name': 'Hair Net', 'category': 'Supplies', 'unit': 'pack', 'departments': ['Kitchen (Nox)'], 'cost': 0},
